...
f=open('train-scale_4btestset5_basicTfidfWithMT2Class1.txt','r+')#features4b_testset4_rm1166_tfidf_1.txt
f1=open('features4b_testset5_basicTfidf3_addSemanticType_scaled_ano.txt','r+')
f2=open('BioASQ-trainingDataset4b_0-1307_DividedByWordsNum_writeSemanticTypeNum.txt','r+')
result=[]
